              ...
              <View style={Styles.photo}>
                ...
                <View style={Styles.photoItem}>
                  <Image
                    source={{
                      uri:
                        'https://marketplace.canva.com/MACViAoaMik/1/screen/canva-kitchen%2C-home%2C-house%2C-interior%2C-modern%2C-room%2C-floor-MACViAoaMik.jpg'
                    }}
                    style={Styles.photoIcon}
                  />
                  <Button style={Styles.photoDelete}>
                ...
                <View style={Styles.photoItem}>
                  <Image
                    source={{
                      uri:
                        'https://marketplace.canva.com/MACV3QT96xw/1/screen/canva-interior-design%2C-home%2C-house%2C-design%2C-room%2C-furniture-MACV3QT96xw.jpg'
                    }}
                    style={Styles.photoIcon}
                  />
                  <Button style={Styles.photoDelete}>
                ...
                <View style={Styles.photoItem}>
                  <Image
                    source={{
                      uri:
                        'https://marketplace.canva.com/MAC3YeUwhqQ/1/screen/canva-furniture%2C-chair%2C-interior%2C-modern%2C-room%2C-home%2C-table-MAC3YeUwhqQ.jpg'
                    }}
                    style={Styles.photoIcon}
                  />
                  <Button style={Styles.photoDelete}>
                ...
                <View style={Styles.photoItem}>
                  <Image
                    source={{
                      uri:
                        'https://marketplace.canva.com/MAC4hLqI8bY/1/screen/canva-interior%2C-living-room%2C-living-room-interior%2C-living-MAC4hLqI8bY.jpg'
                    }}
                    style={Styles.photoIcon}
                  />
                  <Button style={Styles.photoDelete}>
                ...
                <View style={Styles.photoItem}>
                  <Image
                    source={{
                      uri:
                        'https://i.pinimg.com/736x/17/48/86/1748869b10e305dfd5403c84fff02d22--zen-bedrooms-luxury-bedrooms.jpg'
                    }}
                    style={Styles.photoIcon}
                  />
                  <Button style={Styles.photoDelete}>
